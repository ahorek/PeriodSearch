...
"\n"
"		(*CUDA_LCC).jp_Scale[jp] = fma(cg[(*CUDA_CC).Ncoef0 + 3], alpha, fma(cg[(*CUDA_CC).Ncoef0 + 1], f, 1));\n"
...
"			tmp5 = fma(ar * lmu * lmu0, inv_sum, tmp5);\n"
"		}\n"
"	}\n"
"\n"
