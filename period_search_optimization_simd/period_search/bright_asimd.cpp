...
//   br = 0;
   ...
   for (i = 0; i < cyklus1; i+=10) //5 * 2doubles
   {
      ...
      tmp1 = vfmaq_f64(vfmaq_f64(vfmaq_f64(vfmaq_f64(pdbr, tmp1, Dgrow[0]), pdbr1, Dgrow1[0]), pdbr2, Dgrow2[0]), pdbr3, Dgrow3[0]);
      tmp2 = vfmaq_f64(vfmaq_f64(vfmaq_f64(vfmaq_f64(pdbr, tmp2, Dgrow[0]), pdbr1, Dgrow1[1]), pdbr2, Dgrow2[1]), pdbr3, Dgrow3[1]);
      tmp3 = vfmaq_f64(vfmaq_f64(vfmaq_f64(vfmaq_f64(pdbr, tmp3, Dgrow[0]), pdbr1, Dgrow1[2]), pdbr2, Dgrow2[2]), pdbr3, Dgrow3[2]);
      tmp4 = vfmaq_f64(vfmaq_f64(vfmaq_f64(vfmaq_f64(pdbr, tmp4, Dgrow[0]), pdbr1, Dgrow1[3]), pdbr2, Dgrow2[3]), pdbr3, Dgrow3[3]);
      tmp5 = vfmaq_f64(vfmaq_f64(vfmaq_f64(vfmaq_f64(pdbr, tmp5, Dgrow[0]), pdbr1, Dgrow1[4]), pdbr2, Dgrow2[4]), pdbr3, Dgrow3[4]);
